    ...
    private class KeyEventHandler implements EventHandler<KeyEvent> {
        ...
        public void handle(KeyEvent keyEvent) {
            if (keyEvent.getEventType() == KeyEvent.KEY_TYPED) {
                ...
                // capitalization.
                characterTyped = characterTyped + keyEvent.getCharacter();
                if (characterTyped.length() > 0 && characterTyped.charAt(characterTyped.length()-1) != 8) {
                ...
                if (code == KeyCode.UP) {
                    ...
                    characterTyped = characterTyped.substring(0, characterTyped.length()-1);
                    displayText.setText(characterTyped);
                }
            }
        }
