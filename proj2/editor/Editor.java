...
public class Editor extends Application {
    ...
    private class KeyEventHandler implements EventHandler<KeyEvent> {
        ...
        //keeps track of all the things typed
        String stringTyped = "";
        ...
        public void handle(KeyEvent keyEvent) {
            if (keyEvent.getEventType() == KeyEvent.KEY_TYPED) {
                ...
                //keeps track of string's length before modification
                int stringLength = stringTyped.length();
                stringTyped = stringTyped + keyEvent.getCharacter();

                if (stringTyped.length() - stringLength > 0 && stringTyped.charAt(stringTyped.length()-1) != 8) {
                    ...
                    keyEvent.consume();
                } else if (stringTyped.charAt(stringTyped.length()-1) == 8){
